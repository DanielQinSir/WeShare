 ...
 */
public class OneGoodGridFragment extends Fragment {
    private Context mContext;
    private String catid;
    private Bundle bd;
    private RecyclerView grid_recyclerview;
    private GridRecyclerViewAdapter2 adapter2;
    ...
    public static OneGoodGridFragment newInstance(String catid) {

        Bundle args = new Bundle();
        args.putString("catid",catid);
        OneGoodGridFragment fragment = new OneGoodGridFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter2 = new GridRecyclerViewAdapter2();
        grid_recyclerview.setAdapter(adapter2);
        loadDatas();
        return view;
    }
